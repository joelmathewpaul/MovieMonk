...
export default class User {
    ...
    static getUserDetails(res) {
        return new User(res._id, res.name, res.email, res.profilePhoto, res.headerImage, res.biography, res.dob, res.joined, res.accountType, res.followersCount, res.followingCount);

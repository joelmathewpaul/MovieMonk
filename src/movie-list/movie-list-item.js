...
/**
 * Responsible for individual movie item that is to be handles.
 * Stores each item.
 */
const MovieListItem = ({ movie, onDelete }) => {
  ...
  /**
   * Responsible for deleting movie from the list.
   */
      ...
      <div className="p-15 rounded-3">
        {!!onDelete && (
          <div className="position-relative">
            <i
              className="position-absolute fa fa-times p-2 text-muted"
              title="Remove"
              style={{ right: -10 }}

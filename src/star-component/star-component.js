...
const StarComponent = ({disabled  , rating=3.6 }) =>{
                    ...
                    <div className="row justify-content-center">
                        <div className="rating-wrapper align-self-center border-5 d-inline-flex pt-2 pe-3 " dir="rtl">
                            ...
                            checked={currentRating >4}/>
                                ...
                                <input type="radio" id="4-star-rating" checked={currentRating > 3 && currentRating <= 4} name="star-rating" disabled={disabled} onChange={() => setRating(4)} className="h-100 w-100 d-none"/>
                                    ...
                                    <input type="radio" id="3-star-rating"
                                           checked={currentRating > 2 && currentRating <= 3} disabled={disabled} onChange={() => setRating(3)} name="star-rating"  className="h-100 w-100 d-none"/>
                                        ...
                                        <input type="radio" id="2-star-rating"
                                               checked={currentRating > 1 && currentRating <= 2} disabled={disabled} onChange={() => setRating(2)} name="star-rating"  className="h-100 w-100 d-none"/>
                                            ...
                                            <input type="radio" id="1-star-rating"
                                                   checked={currentRating  > 0 && currentRating <= 1} disabled={disabled} onChange={() => setRating(1)} name="star-rating"  className="h-100 w-100 d-none"/>
